...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="admin-css/produtos.css">
    ...
    <section>
        <div class="container int">
            <div class="search d-flex justify-content-between align-items-center">
                <button class='btn btn-secondary btn-header'> FILTROS </button>
                <p class='btn-header'> <strong> 27 </strong > Produtos </p>
                <div class="search-box">
                <form action="" class='form-search btn-header'>
                    <label class='m-0' for="userEmail">Nome:</label>
                    <div class="input-area">
                        <input type="email" required>
                        <div class="search-button">
                            <img src="../assets/img/lupa.svg" class='' alt="">
                        </div>
                    </div>
                    
                </form>
                </div>
                <button class='btn btn-primary btn-header'> ADICIONAR PRODUTO </button>
            </div>
