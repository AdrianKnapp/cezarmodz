...
class Usuarios {
  ...
  public function fazerLogin($loginEmail, $loginSenha) {
    $loginEmail = addslashes($loginEmail);
    $loginSenha = addslashes($loginSenha);
    $sql = "SELECT * FROM usuarios WHERE email = '$loginEmail' AND senha = '$loginSenha' AND email_confirmacao = 1";
